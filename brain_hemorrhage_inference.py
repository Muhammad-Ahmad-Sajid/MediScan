...
def get_clinical_recommendation(has_hemorrhage, confidence_flag):
    ...
    if has_hemorrhage:
        if confidence_flag == "clear":
            rec = (
                "EMERGENCY: Intracranial hemorrhage detected with high confidence.\n"
            ...
            rec = (
                "EMERGENCY: CT findings strongly suggest intracranial hemorrhage.\n"
            ...
            rec = (
                "WARNING: Possible intracranial hemorrhage detected.\n"
        ...
        if confidence_flag == "likely_normal":
            rec = (
                "No definitive hemorrhage identified, but findings warrant caution.\n"
            ...
            rec = (
                "No intracranial hemorrhage detected on CT.\n"
