...
def main():
    ...
    for boost in [1.0] + boost_factors:
        ...
        if boost == 1.0:
            print(f"1.0 (B) | {overall_acc*100:>8.2f}%   | {recalls[1]*100:>7.2f}%   | {recalls[0]*100:>8.2f}% | {recalls[2]*100:>9.2f}% | {recalls[3]*100:>8.2f}%")
            print("-" * 70)
            continue
            
        print(f"{boost:<6.1f} | {overall_acc*100:>8.2f}%   | {recalls[1]*100:>7.2f}%   | {recalls[0]*100:>8.2f}% | {recalls[2]*100:>9.2f}% | {recalls[3]*100:>8.2f}%")
