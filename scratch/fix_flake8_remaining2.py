...
content = content.replace(
    'logger.error(f"Error generating TB report: {e}")',
    'logger.error("Error generating TB report")',
)
content = content.replace(
    'logger.error(f"Error in bone age prediction: {e}")',
    'logger.error("Error in bone age prediction")',
)
