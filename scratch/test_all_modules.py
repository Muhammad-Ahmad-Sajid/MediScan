...
def test_override(endpoint_prefix, scan_id, token):
    ...
    try:
        ...
        data = {"clinician_override": "Test Override", "override_notes": "Test"}
        res = requests.patch(
            f"{BASE_URL}{endpoint_prefix}/{scan_id}/override",
            json=data,
            headers=headers,
        )
        if res.status_code == 200:
...
MODULES = [
    {
        "name": "Module 1 & 2 (Fracture)",
        "upload": "/fracture/scan/upload",
        "report": None,
        "history": "/patients/{}/fracture-history",
        "override": "/fracture",
    },
    {
        "name": "Module 3 (Osteoporosis)",
        "upload": "/osteoporosis/scan/upload",
        "report": None,
        "history": "/patients/{}/osteoporosis-history",
        "override": "/osteoporosis",
    },
    {
        "name": "Module 4 (Arthritis)",
        "upload": "/arthritis/scan/upload",
        "report": None,
        "history": "/patients/{}/arthritis-history",
        "override": "/arthritis",
    },
    {
        "name": "Module 5 (TB)",
        "upload": "/tb/scan/upload",
        "report": "/tb/scan",
        "history": "/patients/{}/tb-history",
        "override": "/tb",
    },
    {
        "name": "Module 5b (Lung Nodule)",
        "upload": "/lung-nodule/scan/upload",
        "report": "/lung-nodule/scan",
        "history": "/patients/{}/lung-nodule-history",
        "override": "/lung-nodule",
    },
    {
        "name": "Module 6 (Brain Tumor)",
        "upload": "/brain-tumor/scan/upload",
        "report": "/brain-tumor/scan",
        "history": "/patients/{}/brain-tumor-history",
        "override": "/brain-tumor",
    },
    {
        "name": "Module 7 (Brain Hemorrhage)",
        "upload": "/brain-hemorrhage/scan/upload",
        "report": "/brain-hemorrhage/scan",
        "history": "/patients/{}/brain-hemorrhage-history",
        "override": "/brain-hemorrhage",
    },
    {
        "name": "Module 8 (Bone Age)",
        "upload": "/bone-age/scan/upload",
        "report": "/bone-age/scan",
        "history": "/patients/{}/bone-age-history",
        "override": None,
    },
    {
        "name": "Module 9 (Retinopathy)",
        "upload": "/retinopathy/scan/upload",
        "report": "/retinopathy/scan",
        "history": "/patients/{}/retinopathy-history",
        "override": "/retinopathy/scan",
    },
]
...
def main():
    ...
    for r in results:
        if (
            r["Upload (Inference)"] != "PASS"
            or "FAIL" in r["Report (PDF)"]
            or "FAIL" in r["History"]
            or "FAIL" in r["Override"]
        ):
