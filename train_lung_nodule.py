...
def main():
    ...
    with mlflow.start_run(run_name="lung_nodule_v1"):
        ...
        for epoch in range(1, EPOCHS + 1):
            ...
            print(
                f"{epoch:5} | {t_loss:10.4f} | {t_acc:9.4f} | {v_loss:8.4f} | {v_acc:7.4f} | {sens:11.4f} | {spec:11.4f} | {current_lr:.2e}"
            )
            ...
            mlflow.log_metrics(
                {
                    ...
                    "train_acc": t_acc,
                    "val_acc": v_acc,
                    "nodule_sensitivity": sens,
                    "nodule_specificity": spec,
                },
                step=epoch,
            )
    ...
    if test_sens < 0.80:
        ...
        print(
            "Consider: (1) lowering classification threshold, (2) adding more augmentation, (3) combining with additional data."
        )
